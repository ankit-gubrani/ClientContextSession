if (CQ_Analytics.MyTestContextStore) {
    ...
    CQ_Analytics.MyTestContextStore.createHTMLElement = function () {
    ...
    CQ_Analytics.MyTestContextStore.renderer = function (store, targetId) {
        CQ_Analytics.MyTestContextStore.targetId = targetId;
        if (store && store.STORENAME == CQ_Analytics.MyTestContextStore.STORENAME) {
